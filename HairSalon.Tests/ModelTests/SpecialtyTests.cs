...
namespace HairSalon.Tests
  {
      ...
      public class SpecialtyTests : IDisposable
      {
        ...
        public void StylistADDGET_AddSpecialtyAndReturnThem_True()
        {
            ...
            Console.WriteLine(testList[0].Id + " " + testList[0].Name);
            Console.WriteLine(resultList[0].Id + " " + resultList[0].Name);
            Console.WriteLine(testList[1].Id + " " + testList[1].Name);
            Console.WriteLine(resultList[1].Id + " " + resultList[1].Name);
